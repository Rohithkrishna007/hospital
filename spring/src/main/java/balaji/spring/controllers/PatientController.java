...
public class PatientController {
    ...
    @GetMapping("/patient/sorted-order")
    //http://localhost:8080/patients/sorted-order?pageNumber=0&pageSize=10&sortOrder=desc
    //http://localhost:8080/patients/sorted-order?pageNumber=0&pageSize=10&sortOrder=asc
